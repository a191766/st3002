...
# ==========================================
# 設定區 v9.55.15 (圖表顯示優化版)
# ==========================================
APP_VER = "v9.55.15 (圖表顯示優化版)"
TOP_N = 300              
BREADTH_THR = 0.65 
BREADTH_LOW = 0.55 
RAPID_THR = 0.03 
...
def get_chip_strategy(ma5_slope, chips):
    ...
    if ma5_slope <= 0 and fut_oi < -10000 and margin_chg > 0:
        ...
        color = "success"
    elif abs(ma5_slope) < 10 and margin_chg > 10: # 盤整融資大增
        sig = "🟥 溫水煮青蛙 (散戶堆疊)"
...
def plot_chart():
    ...
    try:
        ...
        # Now get all data for that date 
        chart_data = df_valid[df_valid['Date'] == base_d].copy()
        
        # Construct DT column for Altair
...
if __name__ == "__main__":
    ...
    if 'streamlit' in sys.modules and any('streamlit' in arg for arg in sys.argv):
        ...
        print("正在啟動 Streamlit 介面 (圖表顯示優化版)...")
        try:
